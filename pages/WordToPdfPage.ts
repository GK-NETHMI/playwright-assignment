...
export class WordToPdfPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.downloadButton = page.getByRole('button', { name: /convert to pdf/i }).last();
    this.previewSection = page.locator('text=Preview').first();
  }

  async navigateToWordToPdf() {
    await this.goto('/word-to-pdf');
  }

  async uploadWordDoc(filePath: string) {
